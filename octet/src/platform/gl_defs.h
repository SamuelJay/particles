...
typedef void           (GL_APIENTRY *glGetInternalformativ_t) (GLenum target, GLenum internalformat, GLenum pname, GLsizei bufSize, GLint* params);
  ...
  void init_wgl() {
    ...
    glActiveTexture = (glActiveTexture_t)wglGetProcAddress("glActiveTexture");
    glAttachShader = (glAttachShader_t)wglGetProcAddress("glAttachShader");
    glBindAttribLocation = (glBindAttribLocation_t)wglGetProcAddress("glBindAttribLocation");
    glBindBuffer = (glBindBuffer_t)wglGetProcAddress("glBindBuffer");
    ...
    //glBindTexture = (glBindTexture_t)wglGetProcAddress("glBindTexture");
    glBlendColor = (glBlendColor_t)wglGetProcAddress("glBlendColor");
    glBlendEquation = (glBlendEquation_t)wglGetProcAddress("glBlendEquation");
    glBlendEquationSeparate = (glBlendEquationSeparate_t)wglGetProcAddress("glBlendEquationSeparate");
    //glBlendFunc = (glBlendFunc_t)wglGetProcAddress("glBlendFunc");
    glBlendFuncSeparate = (glBlendFuncSeparate_t)wglGetProcAddress("glBlendFuncSeparate");
    glBufferData = (glBufferData_t)wglGetProcAddress("glBufferData");
    glBufferSubData = (glBufferSubData_t)wglGetProcAddress("glBufferSubData");
    glCheckFramebufferStatus = (glCheckFramebufferStatus_t)wglGetProcAddress("glCheckFramebufferStatus");
    //glClear = (glClear_t)wglGetProcAddress("glClear");
    //glClearColor = (glClearColor_t)wglGetProcAddress("glClearColor");
    glClearDepthf = (glClearDepthf_t)wglGetProcAddress("glClearDepthf");
    //glClearStencil = (glClearStencil_t)wglGetProcAddress("glClearStencil");
    //glColorMask = (glColorMask_t)wglGetProcAddress("glColorMask");
    glCompileShader = (glCompileShader_t)wglGetProcAddress("glCompileShader");
    glCompressedTexImage2D = (glCompressedTexImage2D_t)wglGetProcAddress("glCompressedTexImage2D");
    glCompressedTexSubImage2D = (glCompressedTexSubImage2D_t)wglGetProcAddress("glCompressedTexSubImage2D");
    //glCopyTexImage2D = (glCopyTexImage2D_t)wglGetProcAddress("glCopyTexImage2D");
    //glCopyTexSubImage2D = (glCopyTexSubImage2D_t)wglGetProcAddress("glCopyTexSubImage2D");
    ...
    //glCullFace = (glCullFace_t)wglGetProcAddress("glCullFace");
    glDeleteBuffers = (glDeleteBuffers_t)wglGetProcAddress("glDeleteBuffers");
    glDeleteFramebuffers = (glDeleteFramebuffers_t)wglGetProcAddress("glDeleteFramebuffers");
    glDeleteProgram = (glDeleteProgram_t)wglGetProcAddress("glDeleteProgram");
    glDeleteRenderbuffers = (glDeleteRenderbuffers_t)wglGetProcAddress("glDeleteRenderbuffers");
    glDeleteShader = (glDeleteShader_t)wglGetProcAddress("glDeleteShader");
    //glDeleteTextures = (glDeleteTextures_t)wglGetProcAddress("glDeleteTextures");
    //glDepthFunc = (glDepthFunc_t)wglGetProcAddress("glDepthFunc");
    //glDepthMask = (glDepthMask_t)wglGetProcAddress("glDepthMask");
    glDepthRangef = (glDepthRangef_t)wglGetProcAddress("glDepthRangef");
    glDetachShader = (glDetachShader_t)wglGetProcAddress("glDetachShader");
    //glDisable = (glDisable_t)wglGetProcAddress("glDisable");
    glDisableVertexAttribArray = (glDisableVertexAttribArray_t)wglGetProcAddress("glDisableVertexAttribArray");
    //glDrawArrays = (glDrawArrays_t)wglGetProcAddress("glDrawArrays");
    //glDrawElements = (glDrawElements_t)wglGetProcAddress("glDrawElements");
    //glEnable = (glEnable_t)wglGetProcAddress("glEnable");
    glEnableVertexAttribArray = (glEnableVertexAttribArray_t)wglGetProcAddress("glEnableVertexAttribArray");
    //glFinish = (glFinish_t)wglGetProcAddress("glFinish");
    //glFlush = (glFlush_t)wglGetProcAddress("glFlush");
    ...
    //glFrontFace = (glFrontFace_t)wglGetProcAddress("glFrontFace");
    glGenBuffers = (glGenBuffers_t)wglGetProcAddress("glGenBuffers");
    glGenerateMipmap = (glGenerateMipmap_t)wglGetProcAddress("glGenerateMipmap");
    ...
    //glGenTextures = (glGenTextures_t)wglGetProcAddress("glGenTextures");
    glGetActiveAttrib = (glGetActiveAttrib_t)wglGetProcAddress("glGetActiveAttrib");
    glGetActiveUniform = (glGetActiveUniform_t)wglGetProcAddress("glGetActiveUniform");
    glGetAttachedShaders = (glGetAttachedShaders_t)wglGetProcAddress("glGetAttachedShaders");
    glGetAttribLocation = (glGetAttribLocation_t)wglGetProcAddress("glGetAttribLocation");
    //glGetBooleanv = (glGetBooleanv_t)wglGetProcAddress("glGetBooleanv");
    glGetBufferParameteriv = (glGetBufferParameteriv_t)wglGetProcAddress("glGetBufferParameteriv");
    //glGetError = (glGetError_t)wglGetProcAddress("glGetError");
    //glGetFloatv = (glGetFloatv_t)wglGetProcAddress("glGetFloatv");
    glGetFramebufferAttachmentParameteriv = (glGetFramebufferAttachmentParameteriv_t)wglGetProcAddress("glGetFramebufferAttachmentParameteriv");
    //glGetIntegerv = (glGetIntegerv_t)wglGetProcAddress("glGetIntegerv");
    glGetProgramiv = (glGetProgramiv_t)wglGetProcAddress("glGetProgramiv");
    glGetProgramInfoLog = (glGetProgramInfoLog_t)wglGetProcAddress("glGetProgramInfoLog");
    glGetRenderbufferParameteriv = (glGetRenderbufferParameteriv_t)wglGetProcAddress("glGetRenderbufferParameteriv");
    ...
    glGetShaderPrecisionFormat = (glGetShaderPrecisionFormat_t)wglGetProcAddress("glGetShaderPrecisionFormat");
    glGetShaderSource = (glGetShaderSource_t)wglGetProcAddress("glGetShaderSource");
    //glGetString = (glGetString_t)wglGetProcAddress("glGetString");
    //glGetTexParameterfv = (glGetTexParameterfv_t)wglGetProcAddress("glGetTexParameterfv");
    //glGetTexParameteriv = (glGetTexParameteriv_t)wglGetProcAddress("glGetTexParameteriv");
    glGetUniformfv = (glGetUniformfv_t)wglGetProcAddress("glGetUniformfv");
    glGetUniformiv = (glGetUniformiv_t)wglGetProcAddress("glGetUniformiv");
    glGetUniformLocation = (glGetUniformLocation_t)wglGetProcAddress("glGetUniformLocation");
    glGetVertexAttribfv = (glGetVertexAttribfv_t)wglGetProcAddress("glGetVertexAttribfv");
    glGetVertexAttribiv = (glGetVertexAttribiv_t)wglGetProcAddress("glGetVertexAttribiv");
    glGetVertexAttribPointerv = (glGetVertexAttribPointerv_t)wglGetProcAddress("glGetVertexAttribPointerv");
    //glHint = (glHint_t)wglGetProcAddress("glHint");
    glIsBuffer = (glIsBuffer_t)wglGetProcAddress("glIsBuffer");
    //glIsEnabled = (glIsEnabled_t)wglGetProcAddress("glIsEnabled");
    glIsFramebuffer = (glIsFramebuffer_t)wglGetProcAddress("glIsFramebuffer");
    glIsProgram = (glIsProgram_t)wglGetProcAddress("glIsProgram");
    glIsRenderbuffer = (glIsRenderbuffer_t)wglGetProcAddress("glIsRenderbuffer");
    glIsShader = (glIsShader_t)wglGetProcAddress("glIsShader");
    //glIsTexture = (glIsTexture_t)wglGetProcAddress("glIsTexture");
    //glLineWidth = (glLineWidth_t)wglGetProcAddress("glLineWidth");
    glLinkProgram = (glLinkProgram_t)wglGetProcAddress("glLinkProgram");
    //glPixelStorei = (glPixelStorei_t)wglGetProcAddress("glPixelStorei");
    //glPolygonOffset = (glPolygonOffset_t)wglGetProcAddress("glPolygonOffset");
    //glReadPixels = (glReadPixels_t)wglGetProcAddress("glReadPixels");
    glReleaseShaderCompiler = (glReleaseShaderCompiler_t)wglGetProcAddress("glReleaseShaderCompiler");
    glRenderbufferStorage = (glRenderbufferStorage_t)wglGetProcAddress("glRenderbufferStorage");
    glSampleCoverage = (glSampleCoverage_t)wglGetProcAddress("glSampleCoverage");
    //glScissor = (glScissor_t)wglGetProcAddress("glScissor");
    glShaderBinary = (glShaderBinary_t)wglGetProcAddress("glShaderBinary");
    glShaderSource = (glShaderSource_t)wglGetProcAddress("glShaderSource");
    //glStencilFunc = (glStencilFunc_t)wglGetProcAddress("glStencilFunc");
    glStencilFuncSeparate = (glStencilFuncSeparate_t)wglGetProcAddress("glStencilFuncSeparate");
    //glStencilMask = (glStencilMask_t)wglGetProcAddress("glStencilMask");
    glStencilMaskSeparate = (glStencilMaskSeparate_t)wglGetProcAddress("glStencilMaskSeparate");
    //glStencilOp = (glStencilOp_t)wglGetProcAddress("glStencilOp");
    glStencilOpSeparate = (glStencilOpSeparate_t)wglGetProcAddress("glStencilOpSeparate");
    //glTexImage2D = (glTexImage2D_t)wglGetProcAddress("glTexImage2D");
    //glTexParameterf = (glTexParameterf_t)wglGetProcAddress("glTexParameterf");
    //glTexParameterfv = (glTexParameterfv_t)wglGetProcAddress("glTexParameterfv");
    //glTexParameteri = (glTexParameteri_t)wglGetProcAddress("glTexParameteri");
    //glTexParameteriv = (glTexParameteriv_t)wglGetProcAddress("glTexParameteriv");
    //glTexSubImage2D = (glTexSubImage2D_t)wglGetProcAddress("glTexSubImage2D");
    glUniform1f = (glUniform1f_t)wglGetProcAddress("glUniform1f");
    glUniform1fv = (glUniform1fv_t)wglGetProcAddress("glUniform1fv");
    glUniform1i = (glUniform1i_t)wglGetProcAddress("glUniform1i");
    glUniform1iv = (glUniform1iv_t)wglGetProcAddress("glUniform1iv");
    glUniform2f = (glUniform2f_t)wglGetProcAddress("glUniform2f");
    glUniform2fv = (glUniform2fv_t)wglGetProcAddress("glUniform2fv");
    glUniform2i = (glUniform2i_t)wglGetProcAddress("glUniform2i");
    glUniform2iv = (glUniform2iv_t)wglGetProcAddress("glUniform2iv");
    glUniform3f = (glUniform3f_t)wglGetProcAddress("glUniform3f");
    glUniform3fv = (glUniform3fv_t)wglGetProcAddress("glUniform3fv");
    glUniform3i = (glUniform3i_t)wglGetProcAddress("glUniform3i");
    glUniform3iv = (glUniform3iv_t)wglGetProcAddress("glUniform3iv");
    glUniform4f = (glUniform4f_t)wglGetProcAddress("glUniform4f");
    glUniform4fv = (glUniform4fv_t)wglGetProcAddress("glUniform4fv");
    glUniform4i = (glUniform4i_t)wglGetProcAddress("glUniform4i");
    glUniform4iv = (glUniform4iv_t)wglGetProcAddress("glUniform4iv");
    glUniformMatrix2fv = (glUniformMatrix2fv_t)wglGetProcAddress("glUniformMatrix2fv");
    glUniformMatrix3fv = (glUniformMatrix3fv_t)wglGetProcAddress("glUniformMatrix3fv");
    glUniformMatrix4fv = (glUniformMatrix4fv_t)wglGetProcAddress("glUniformMatrix4fv");
    glUseProgram = (glUseProgram_t)wglGetProcAddress("glUseProgram");
    glValidateProgram = (glValidateProgram_t)wglGetProcAddress("glValidateProgram");
    glVertexAttrib1f = (glVertexAttrib1f_t)wglGetProcAddress("glVertexAttrib1f");
    glVertexAttrib1fv = (glVertexAttrib1fv_t)wglGetProcAddress("glVertexAttrib1fv");
    glVertexAttrib2f = (glVertexAttrib2f_t)wglGetProcAddress("glVertexAttrib2f");
    glVertexAttrib2fv = (glVertexAttrib2fv_t)wglGetProcAddress("glVertexAttrib2fv");
    glVertexAttrib3f = (glVertexAttrib3f_t)wglGetProcAddress("glVertexAttrib3f");
    glVertexAttrib3fv = (glVertexAttrib3fv_t)wglGetProcAddress("glVertexAttrib3fv");
    glVertexAttrib4f = (glVertexAttrib4f_t)wglGetProcAddress("glVertexAttrib4f");
    glVertexAttrib4fv = (glVertexAttrib4fv_t)wglGetProcAddress("glVertexAttrib4fv");
    glVertexAttribPointer = (glVertexAttribPointer_t)wglGetProcAddress("glVertexAttribPointer");
    //glViewport = (glViewport_t)wglGetProcAddress("glViewport");

    /* OpenGL ES 3.0 */

    //glReadBuffer = (glReadBuffer_t)wglGetProcAddress("glReadBuffer");
    glDrawRangeElements = (glDrawRangeElements_t)wglGetProcAddress("glDrawRangeElements");
    glTexImage3D = (glTexImage3D_t)wglGetProcAddress("glTexImage3D");
    glTexSubImage3D = (glTexSubImage3D_t)wglGetProcAddress("glTexSubImage3D");
    glCopyTexSubImage3D = (glCopyTexSubImage3D_t)wglGetProcAddress("glCopyTexSubImage3D");
    glCompressedTexImage3D = (glCompressedTexImage3D_t)wglGetProcAddress("glCompressedTexImage3D");
    glCompressedTexSubImage3D = (glCompressedTexSubImage3D_t)wglGetProcAddress("glCompressedTexSubImage3D");
    glGenQueries = (glGenQueries_t)wglGetProcAddress("glGenQueries");
    glDeleteQueries = (glDeleteQueries_t)wglGetProcAddress("glDeleteQueries");
    glIsQuery = (glIsQuery_t)wglGetProcAddress("glIsQuery");
    glBeginQuery = (glBeginQuery_t)wglGetProcAddress("glBeginQuery");
    glEndQuery = (glEndQuery_t)wglGetProcAddress("glEndQuery");
    glGetQueryiv = (glGetQueryiv_t)wglGetProcAddress("glGetQueryiv");
    glGetQueryObjectuiv = (glGetQueryObjectuiv_t)wglGetProcAddress("glGetQueryObjectuiv");
    glUnmapBuffer = (glUnmapBuffer_t)wglGetProcAddress("glUnmapBuffer");
    glGetBufferPointerv = (glGetBufferPointerv_t)wglGetProcAddress("glGetBufferPointerv");
    glDrawBuffers = (glDrawBuffers_t)wglGetProcAddress("glDrawBuffers");
    glUniformMatrix2x3fv = (glUniformMatrix2x3fv_t)wglGetProcAddress("glUniformMatrix2x3fv");
    glUniformMatrix3x2fv = (glUniformMatrix3x2fv_t)wglGetProcAddress("glUniformMatrix3x2fv");
    glUniformMatrix2x4fv = (glUniformMatrix2x4fv_t)wglGetProcAddress("glUniformMatrix2x4fv");
    glUniformMatrix4x2fv = (glUniformMatrix4x2fv_t)wglGetProcAddress("glUniformMatrix4x2fv");
    glUniformMatrix3x4fv = (glUniformMatrix3x4fv_t)wglGetProcAddress("glUniformMatrix3x4fv");
    glUniformMatrix4x3fv = (glUniformMatrix4x3fv_t)wglGetProcAddress("glUniformMatrix4x3fv");
    glBlitFramebuffer = (glBlitFramebuffer_t)wglGetProcAddress("glBlitFramebuffer");
    glRenderbufferStorageMultisample = (glRenderbufferStorageMultisample_t)wglGetProcAddress("glRenderbufferStorageMultisample");
    glFramebufferTextureLayer = (glFramebufferTextureLayer_t)wglGetProcAddress("glFramebufferTextureLayer");
    glMapBufferRange = (glMapBufferRange_t)wglGetProcAddress("glMapBufferRange");
    glFlushMappedBufferRange = (glFlushMappedBufferRange_t)wglGetProcAddress("glFlushMappedBufferRange");
    glBindVertexArray = (glBindVertexArray_t)wglGetProcAddress("glBindVertexArray");
    glDeleteVertexArrays = (glDeleteVertexArrays_t)wglGetProcAddress("glDeleteVertexArrays");
    glGenVertexArrays = (glGenVertexArrays_t)wglGetProcAddress("glGenVertexArrays");
    glIsVertexArray = (glIsVertexArray_t)wglGetProcAddress("glIsVertexArray");
    glGetIntegeri_v = (glGetIntegeri_v_t)wglGetProcAddress("glGetIntegeri_v");
    glBeginTransformFeedback = (glBeginTransformFeedback_t)wglGetProcAddress("glBeginTransformFeedback");
    glEndTransformFeedback = (glEndTransformFeedback_t)wglGetProcAddress("glEndTransformFeedback");
    glBindBufferRange = (glBindBufferRange_t)wglGetProcAddress("glBindBufferRange");
    glBindBufferBase = (glBindBufferBase_t)wglGetProcAddress("glBindBufferBase");
    glTransformFeedbackVaryings = (glTransformFeedbackVaryings_t)wglGetProcAddress("glTransformFeedbackVaryings");
    glGetTransformFeedbackVarying = (glGetTransformFeedbackVarying_t)wglGetProcAddress("glGetTransformFeedbackVarying");
    glVertexAttribIPointer = (glVertexAttribIPointer_t)wglGetProcAddress("glVertexAttribIPointer");
    glGetVertexAttribIiv = (glGetVertexAttribIiv_t)wglGetProcAddress("glGetVertexAttribIiv");
    glGetVertexAttribIuiv = (glGetVertexAttribIuiv_t)wglGetProcAddress("glGetVertexAttribIuiv");
    glVertexAttribI4i = (glVertexAttribI4i_t)wglGetProcAddress("glVertexAttribI4i");
    glVertexAttribI4ui = (glVertexAttribI4ui_t)wglGetProcAddress("glVertexAttribI4ui");
    glVertexAttribI4iv = (glVertexAttribI4iv_t)wglGetProcAddress("glVertexAttribI4iv");
    glVertexAttribI4uiv = (glVertexAttribI4uiv_t)wglGetProcAddress("glVertexAttribI4uiv");
    glGetUniformuiv = (glGetUniformuiv_t)wglGetProcAddress("glGetUniformuiv");
    glGetFragDataLocation = (glGetFragDataLocation_t)wglGetProcAddress("glGetFragDataLocation");
    glUniform1ui = (glUniform1ui_t)wglGetProcAddress("glUniform1ui");
    glUniform2ui = (glUniform2ui_t)wglGetProcAddress("glUniform2ui");
    glUniform3ui = (glUniform3ui_t)wglGetProcAddress("glUniform3ui");
    glUniform4ui = (glUniform4ui_t)wglGetProcAddress("glUniform4ui");
    glUniform1uiv = (glUniform1uiv_t)wglGetProcAddress("glUniform1uiv");
    glUniform2uiv = (glUniform2uiv_t)wglGetProcAddress("glUniform2uiv");
    glUniform3uiv = (glUniform3uiv_t)wglGetProcAddress("glUniform3uiv");
    glUniform4uiv = (glUniform4uiv_t)wglGetProcAddress("glUniform4uiv");
    glClearBufferiv = (glClearBufferiv_t)wglGetProcAddress("glClearBufferiv");
    glClearBufferuiv = (glClearBufferuiv_t)wglGetProcAddress("glClearBufferuiv");
    glClearBufferfv = (glClearBufferfv_t)wglGetProcAddress("glClearBufferfv");
    glClearBufferfi = (glClearBufferfi_t)wglGetProcAddress("glClearBufferfi");
    glGetStringi = (glGetStringi_t)wglGetProcAddress("glGetStringi");
    glCopyBufferSubData = (glCopyBufferSubData_t)wglGetProcAddress("glCopyBufferSubData");
    glGetUniformIndices = (glGetUniformIndices_t)wglGetProcAddress("glGetUniformIndices");
    glGetActiveUniformsiv = (glGetActiveUniformsiv_t)wglGetProcAddress("glGetActiveUniformsiv");
    glGetUniformBlockIndex = (glGetUniformBlockIndex_t)wglGetProcAddress("glGetUniformBlockIndex");
    glGetActiveUniformBlockiv = (glGetActiveUniformBlockiv_t)wglGetProcAddress("glGetActiveUniformBlockiv");
    glGetActiveUniformBlockName = (glGetActiveUniformBlockName_t)wglGetProcAddress("glGetActiveUniformBlockName");
    glUniformBlockBinding = (glUniformBlockBinding_t)wglGetProcAddress("glUniformBlockBinding");
    glDrawArraysInstanced = (glDrawArraysInstanced_t)wglGetProcAddress("glDrawArraysInstanced");
    glDrawElementsInstanced = (glDrawElementsInstanced_t)wglGetProcAddress("glDrawElementsInstanced");
    glFenceSync = (glFenceSync_t)wglGetProcAddress("glFenceSync");
    glIsSync = (glIsSync_t)wglGetProcAddress("glIsSync");
    glDeleteSync = (glDeleteSync_t)wglGetProcAddress("glDeleteSync");
    glClientWaitSync = (glClientWaitSync_t)wglGetProcAddress("glClientWaitSync");
    glWaitSync = (glWaitSync_t)wglGetProcAddress("glWaitSync");
    glGetInteger64v = (glGetInteger64v_t)wglGetProcAddress("glGetInteger64v");
    glGetSynciv = (glGetSynciv_t)wglGetProcAddress("glGetSynciv");
    glGetInteger64i_v = (glGetInteger64i_v_t)wglGetProcAddress("glGetInteger64i_v");
    glGetBufferParameteri64v = (glGetBufferParameteri64v_t)wglGetProcAddress("glGetBufferParameteri64v");
    glGenSamplers = (glGenSamplers_t)wglGetProcAddress("glGenSamplers");
    glDeleteSamplers = (glDeleteSamplers_t)wglGetProcAddress("glDeleteSamplers");
    glIsSampler = (glIsSampler_t)wglGetProcAddress("glIsSampler");
    glBindSampler = (glBindSampler_t)wglGetProcAddress("glBindSampler");
    glSamplerParameteri = (glSamplerParameteri_t)wglGetProcAddress("glSamplerParameteri");
    glSamplerParameteriv = (glSamplerParameteriv_t)wglGetProcAddress("glSamplerParameteriv");
    glSamplerParameterf = (glSamplerParameterf_t)wglGetProcAddress("glSamplerParameterf");
    glSamplerParameterfv = (glSamplerParameterfv_t)wglGetProcAddress("glSamplerParameterfv");
    glGetSamplerParameteriv = (glGetSamplerParameteriv_t)wglGetProcAddress("glGetSamplerParameteriv");
    glGetSamplerParameterfv = (glGetSamplerParameterfv_t)wglGetProcAddress("glGetSamplerParameterfv");
    glVertexAttribDivisor = (glVertexAttribDivisor_t)wglGetProcAddress("glVertexAttribDivisor");
    glBindTransformFeedback = (glBindTransformFeedback_t)wglGetProcAddress("glBindTransformFeedback");
    glDeleteTransformFeedbacks = (glDeleteTransformFeedbacks_t)wglGetProcAddress("glDeleteTransformFeedbacks");
    glGenTransformFeedbacks = (glGenTransformFeedbacks_t)wglGetProcAddress("glGenTransformFeedbacks");
    glIsTransformFeedback = (glIsTransformFeedback_t)wglGetProcAddress("glIsTransformFeedback");
    glPauseTransformFeedback = (glPauseTransformFeedback_t)wglGetProcAddress("glPauseTransformFeedback");
    glResumeTransformFeedback = (glResumeTransformFeedback_t)wglGetProcAddress("glResumeTransformFeedback");
    glGetProgramBinary = (glGetProgramBinary_t)wglGetProcAddress("glGetProgramBinary");
    glProgramBinary = (glProgramBinary_t)wglGetProcAddress("glProgramBinary");
    glProgramParameteri = (glProgramParameteri_t)wglGetProcAddress("glProgramParameteri");
    glInvalidateFramebuffer = (glInvalidateFramebuffer_t)wglGetProcAddress("glInvalidateFramebuffer");
    glInvalidateSubFramebuffer = (glInvalidateSubFramebuffer_t)wglGetProcAddress("glInvalidateSubFramebuffer");
    glTexStorage2D = (glTexStorage2D_t)wglGetProcAddress("glTexStorage2D");
    glTexStorage3D = (glTexStorage3D_t)wglGetProcAddress("glTexStorage3D");
    glGetInternalformativ = (glGetInternalformativ_t)wglGetProcAddress("glGetInternalformativ");
  }
